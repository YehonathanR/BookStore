    ...
    class Meta:
        constraints = [
            models.CheckConstraint(
                check=Q(first_name__isnull=False, last_name__isnull=False) | Q(company_name__isnull=False),
                name='authors_check_not_empty'),
            models.UniqueConstraint(fields=['first_name', 'last_name'], name='authors_ind_1',
